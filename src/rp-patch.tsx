/*
This file patches some bugs in ractive-player.

In the next version of RP these will be fixed and this file will no longer be necessary.
*/

/*
This is necessary to stop the keyboard controls from being set off
when the user is inputting a Desmos expression.
*/
...
/* turn on captions support */
import {useCallback, useEffect, useMemo, useState} from "react";
import {Controls, Utils, usePlayer} from "ractive-player";
      ...
      <div className="rp-settings-dialog" style={dialogStyle}>
        <table>
          <tbody>
            ...
            <tr onClick={toggleSubtitles}>
              <th scope="row">Captions</th>
              <td>
                <svg height="25" viewBox="0 0 70 50">
                  <rect fill={captions ? "#AF1866" : "#888"} x="2" y="11" height="28" width="66" rx="12" ry="12"/>
